...
declare module "mangopay2-nodejs-sdk" {
   ...
   */
  type MakeKeysOptional<T1, T2 extends keyof T1> = Omit<T1, T2> &
    Partial<Pick<T1, T2>>

  type PickPartial<T, Par extends keyof T> = Pick<Partial<T>, Par>

  type PickPartialRequired<T, Par extends keyof T, Req extends keyof T> = Pick<
    Partial<T>,
    Par
  > &
    Pick<Required<T>, Req>
   ...
   */
  type MakeKeysNullable<T1, T2 extends keyof T1> = Omit<T1, T2> &
    { [P in T2]: T1[P] | null }

  /**
   * Makes specified keys of an interface Required.
   */
  type MakeKeysRequired<T1, T2 extends keyof T1> = Omit<T1, T2> &
    Required<Pick<T1, T2>>
