...
const Eligibility = ({
  ...
  return (
    <Questions
      ...
      questions={[
        {
          text: `The Childcare Cash Advance Scheme is currently only available for permanent employees. Please click the circle below to confirm you are a permanent employee of ${name}.`,
          name: 'permanentRole',
          className: '',
          type: 'checkbox',
